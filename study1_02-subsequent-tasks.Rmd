...
Another common group of correct answers are based on`-1/n` (20 students). These are split fairly evenly between groups, so there is not much evidence that the students in -CG groups are using the example provided in NearC as a basis for answering NearG.
...
TODO - MidG_ans3 seems to be accepting 1/n among correct answers!
