...
responses %>% 
  ...
  labs(x = "")
ggsave("figs/FIG_study1_subsequent-task-scores.eps", device = cairo_ps, width = 12, height = 9, units = "cm")
```
...
ggsave("figs/FIG_study1_task_order.eps", device = cairo_ps, width = 12, height = 7, units = "cm")
```
