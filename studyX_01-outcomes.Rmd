...
ggsave("figs/FIG_studyX_marks_attained.eps", device = cairo_ps, width = 12, height = 7, units = "cm")
```
...
ggsave("figs/FIG_studyX_marks_attained_with_table.eps", device = cairo_ps, width = 10, height = 10, units = "cm")
```
...
p_diffs
ggsave("figs/FIG_studyX_marks_attained_effect.eps", device = cairo_ps, width = 14, height = 4, units = "cm")
```
