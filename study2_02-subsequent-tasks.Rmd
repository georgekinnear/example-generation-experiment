---
title: "Study 2 analysis: subsequent tasks"
...
responses %>% 
  ...
  labs(x = "")
ggsave("figs/FIG_study2_subsequent-task-scores.eps", device = cairo_ps, width = 12, height = 9, units = "cm")
```
...
ggsave("figs/FIG_study2_task_order.eps", device = cairo_ps, width = 12, height = 7, units = "cm")
```
...
responses %>% 
  ...
  write_csv("data-clean/study2_NearG_responses.csv")
...
responses %>% 
  ...
  write_csv("data-clean/study2_MidG_responses.csv")
